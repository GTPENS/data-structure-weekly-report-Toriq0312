...
int main(){
    ...
    sisipkanSimpulAwal(head, tail, 18);
    sisipkanSimpulAwal(head, tail, 37);
    sisipkanSimpulAwal(head, tail, 56);
    sisipkanSimpulAwal(head, tail, 68);
    sisipkanSimpulAwal(head, tail, 74);
